...
from wtv.ion_selection import filter_matrix, generate_ion_combinations, get_nearby_compound_ions, get_nearby_compounds
...
class TestIonSelection(unittest.TestCase):
    ...
    def test_filter_matrix_single(self):
        ...
        expected = pd.DataFrame({"Compound1": [20.0, 30.0], "ion": [204.09, 300.0]}, index=[204.09, 300.0])
    ...
    def test_get_nearby_compound_ions(self):
        actual = get_nearby_compound_ions(self.matrix, 20, "Compound1", ["Compound1", "Compound2"])
        expected = pd.DataFrame({
            204.09: [20.0, 10.0],
            300.0: [30.0, 20.0],
    ...
    def test_generate_ion_combinations(self):
        ...
        }, index=["Compound1", "Compound2", "Compound3"], dtype=object)
